...
**ANSWER:** Code reviews enable me to learn from errors that others make so I don't have
to learn the 'hard way' on my own. I also get to learn new ways of solving
a problem by working in review with another person.

**ANSWER:** Container enable us to transfer packages to each other with the same environment
to eliminate import incompatabilities. It creates a micro environment designed
for the given code.
